...
- [ ] NewsSource interface + RSS fetch in sources/ (1-2 feeds) with a recorded fixture and test — parsing only, no digest wiring yet
- [ ] Attach top-3 relevant headlines to each digest section (uses NewsSource)
