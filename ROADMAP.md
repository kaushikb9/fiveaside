...
- [x] Rename the Python package `terrace` -> `touchline` (imports, pyproject `[tool.hatch...packages]`, test imports); repo + identity already renamed. Do this only after the foundational PRs are merged to main.
