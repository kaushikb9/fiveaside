...
- [ ] Restore dedicated tests for core/models.py (lost in PR reconciliation): winner/draw logic, negative-score ValidationError, goal-difference both signs — match the current models, keep the suite green
